...
const char* ir_inst_src_type_str(IrInstSrcId id) {
    switch (id) {
        ...
        case IrInstSrcIdSetTcExcHandler:
...
static void ir_print_set_tc_exc_handler(IrPrintSrc *irp, IrInstSrcSetTcExcHandler *instruction) {
    fprintf(irp->f, "@setTcExcHandler(");
    ir_print_other_inst_src(irp, instruction->is_exc_handler);
    fprintf(irp->f, ")");
}
...
static void ir_print_inst_src(IrPrintSrc *irp, IrInstSrc *instruction, bool trailing) {
    ...
    switch (instruction->id) {
        ...
        case IrInstSrcIdErrName:
            ...
            break;
        case IrInstSrcIdSetTcExcHandler:
            ir_print_set_tc_exc_handler(irp, (IrInstSrcSetTcExcHandler *)instruction);
            break;
        case IrInstSrcIdCImport:
